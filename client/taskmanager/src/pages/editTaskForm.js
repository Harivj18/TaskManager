...
function EditTaskForm() {
    ...
    const updatedTaskInfo = location.state || {"updatedTaskInfo": {
        "taskNo": "",
        "taskTitle": "",
        "taskDescription": "",
        "dueDate": "",
    ...
    const [taskInfo, setTaskInfo] = useState({
        "taskNo": updatedTaskInfo.taskNo,
        "taskTitle": updatedTaskInfo.taskTitle,
        "taskDescription": updatedTaskInfo.taskDescription,
        "dueDate": updatedTaskInfo.dueDate,
        "priority": updatedTaskInfo.priority,
